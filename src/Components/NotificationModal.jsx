...
export default function NotificationModal() {
    ...
    return (
        <div className="fixed inset-0 bg-silver/10 bg-opacity-40 flex items-center justify-center p-4 z-50">
            <div className={`relative w-full max-w-sm p-6 rounded-lg shadow-lg border-t-4 ${styles.bgColor} ${styles.borderColor}`}>
                ...
                {notification.type !== 'info' && (
                    <button
                        ...
                        className="absolute top-2 right-2 text-charcoal/20 hover:text-charcoal text-2xl"
                        aria-label="Close"
                    >
                        &times;
                    </button>
