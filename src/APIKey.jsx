        ...
        <>
            <div className="bg-gray-50 p-6 rounded-lg space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <button className="bg-indian-red text-charcoal font-bold px-6 py-2 rounded-md hover:bg-opacity-90 hover:transition-colors" onClick={clearApiKey} type="submit">Clear</button>
                </div>
            </div>
        </>
    )
